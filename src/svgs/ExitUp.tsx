...
const SvgExitUp = ({
  ...
  >
    ...
    <path d="m23.4 23.9 6.4-6.3v17.9c0 1.2 1 2.2 2.2 2.2 1.2 0 2.2-1 2.2-2.2V17.7l6.3 6.2c.4.4 1 .6 1.6.6.6 0 1.2-.2 1.6-.7.9-.9.9-2.3 0-3.2l-10.2-10c-.9-.9-2.3-.9-3.2 0l-10.2 10c-.9.9-.9 2.3 0 3.2 1 .9 2.4.9 3.3.1z" />
  </svg>
);
