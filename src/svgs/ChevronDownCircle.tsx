...
const SvgChevronDownCircle = ({
  ...
  >
    ...
    <path d="M43.9 23.8 32 35.5 20.1 23.8c-.9-.9-2.3-.9-3.2 0-.9.9-.9 2.3 0 3.2l13.5 13.3c.4.4 1 .6 1.6.6.6 0 1.1-.2 1.6-.6L47.1 27c.9-.9.9-2.3 0-3.2-.8-.9-2.3-.9-3.2 0z" />
  </svg>
);
