...
const SvgCogs = ({
  ...
  >
    ...
    <path d="M43 34.1c-4.8 0-8.8 4-8.8 8.8s3.9 8.8 8.8 8.8 8.8-4 8.8-8.8-4-8.8-8.8-8.8zm0 13.2c-2.4 0-4.3-1.9-4.3-4.3s1.9-4.3 4.3-4.3 4.3 1.9 4.3 4.3c0 2.3-1.9 4.3-4.3 4.3z" />
