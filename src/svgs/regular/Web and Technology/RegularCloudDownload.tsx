...
const SvgCloudDownload = ({
  ...
  >
    ...
    <path d="m35.7 34.7-1.5 1.5v-6.8c0-1.2-1-2.3-2.3-2.3-1.2 0-2.3 1-2.3 2.3v6.8l-1.4-1.5c-.9-.9-2.3-.9-3.2-.1-.9.9-.9 2.3-.1 3.2l4.8 4.9c.6.6 1.4.9 2.2.9.8 0 1.6-.3 2.2-.9l4.8-4.9c.9-.9.8-2.3-.1-3.2-.8-.8-2.2-.8-3.1.1z" />
