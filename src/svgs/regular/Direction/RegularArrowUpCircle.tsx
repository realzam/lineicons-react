...
const SvgArrowUpCircle = ({
  ...
  >
    ...
    <path d="M33.6 19.1c-.9-.9-2.3-.9-3.2 0l-9.9 9.7c-.9.9-.9 2.3 0 3.2.4.4 1 .7 1.6.7.6 0 1.1-.2 1.6-.6l6.1-6v17.3c0 1.2 1 2.2 2.2 2.2 1.2 0 2.2-1 2.2-2.2V26l6.1 6c.9.9 2.3.9 3.2 0 .9-.9.9-2.3 0-3.2l-9.9-9.7z" />
