...
const SvgChevronUpCircle = ({
  ...
  >
    ...
    <path d="M33.6 23.8c-.9-.9-2.3-.9-3.2 0L16.9 37c-.9.9-.9 2.3 0 3.2.4.4 1 .7 1.6.7.6 0 1.1-.2 1.6-.6L32 28.5l11.9 11.7c.9.9 2.3.9 3.2 0 .9-.9.9-2.3 0-3.2L33.6 23.8z" />
  </svg>
);
