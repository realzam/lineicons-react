...
const SvgArrowRightCircle = ({
  ...
  >
    ...
    <path d="M35.2 20.5c-.9-.9-2.3-.9-3.2 0-.9.9-.9 2.3 0 3.2l6 6.1H20.7c-1.2 0-2.2 1-2.2 2.2 0 1.2 1 2.2 2.2 2.2H38l-6 6.1c-.9.9-.9 2.3 0 3.2.4.4 1 .6 1.6.6.6 0 1.2-.2 1.6-.7l9.8-9.9c.9-.9.9-2.3 0-3.2l-9.8-9.8z" />
